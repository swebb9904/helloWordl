...
let lastName = "Rickman"
var highestScoreSoFar = 93.0
...
// Your code here:
allowedClassPets.update(with: "Fish")


// 4. Below are 3 students packaged into tuples with their name and test score. Create an array of Ints containing just the scores in descending order.
...
// Your code here:
let scores = [studentThree.score, studentTwo.score, studentOne.score]
let fancyWayScore = [studentOne, studentTwo, studentThree].map {
    $0.score
}.sorted(by: >)
...
// Your code here:
var grades: [String : Character] = ["Alex" : "C", "Christina" : "A", "Navdeep" : "B"]
...
func classStatus(student: (name: String, score: Int), threshold: Int) -> String {
...
func classStatusTwo(students: [(name: String, score: Int)], threshold: Int) -> [String] {
    var passingStudents: [String] = []
    for student in students {
        if student.score >= threshold {
            passingStudents.append(student.name)
        }
    }
...
func classStatusThree(students: [(name: String, score: Int)], threshold: Int) -> [(name: String, score: Int)] {
    var passingStudents = students
    passingStudents = passingStudents.filter { (name: String, score: Int) in
        score >= threshold
    }
    return passingStudents
}
